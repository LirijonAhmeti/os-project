...
function A({ ourProps: r8, theirProps: t10, slot: e4, defaultTag: n2, features: o9, visible: a3 = true, name: l9 }) {
  ...
  let u7 = o9 != null ? o9 : 0;
  if (u7 & 2) {
    let { static: i9 = false, ...d7 } = s9;
    if (i9)
      return p3(d7, e4, n2, l9);
  }
  if (u7 & 1) {
    let { unmount: i9 = true, ...d7 } = s9;
    return u2(i9 ? 0 : 1, { [0]() {
      return null;
    }, [1]() {
      return p3({ ...d7, hidden: true, style: { display: "none" } }, e4, n2, l9);
    } });
  }
  return p3(s9, e4, n2, l9);
}
function p3(r8, t10 = {}, e4, n2) {
  let { as: o9 = e4, children: a3, refName: l9 = "ref", ...s9 } = f3(r8, ["unmount", "static"]), u7 = r8.ref !== void 0 ? { [l9]: r8.ref } : {}, i9 = typeof a3 == "function" ? a3(t10) : a3;
...
var Ie = { [1](o9) {
  return o9.disabled || o9.comboboxState === 1 ? o9 : { ...o9, activeOptionIndex: null, comboboxState: 1 };
}, [0](o9) {
  ...
  return l9 !== -1 && (a3 = l9), { ...o9, comboboxState: 0, activeOptionIndex: a3 };
}, [2](o9, a3) {
  return o9.disabled === a3.disabled ? o9 : { ...o9, disabled: a3.disabled };
}, [3](o9, a3) {
  var l9;
  ...
  return { ...o9, ...n2, activeOptionIndex: e4, activationTrigger: (l9 = a3.trigger) != null ? l9 : 1 };
}, [4]: (o9, a3) => {
  ...
  let l9 = { ...o9, ...e4, activationTrigger: 1 };
  ...
  return { ...o9, ...n2, activationTrigger: 1 };
} };
...
var Ee = H(function(a3, n2) {
  let { name: e4, value: l9, onChange: t10, disabled: i9 = false, __demoMode: r8 = false, nullable: u7 = false, multiple: p12 = false, ...x7 } = a3, R5 = (0, import_react14.useRef)(false), c8 = (0, import_react14.useRef)({ value: l9, mode: p12 ? 1 : 0, onChange: t10, nullable: u7, __demoMode: r8 });
  c8.current.value = l9, c8.current.mode = p12 ? 1 : 0, c8.current.nullable = u7;
  let O10 = (0, import_react14.useRef)({ static: false, hold: false }), v7 = (0, import_react14.useRef)({ displayValue: void 0 }), S2 = (0, import_react14.useReducer)(Me, { comboboxState: r8 ? 0 : 1, comboboxPropsRef: c8, optionsPropsRef: O10, inputPropsRef: v7, labelRef: (0, import_react14.createRef)(), inputRef: (0, import_react14.createRef)(), buttonRef: (0, import_react14.createRef)(), optionsRef: (0, import_react14.createRef)(), disabled: i9, options: [], activeOptionIndex: null, activationTrigger: 1 }), [{ comboboxState: s9, options: b9, activeOptionIndex: M7, optionsRef: F10, inputRef: y4, buttonRef: _8 }, d7] = S2, f11 = (0, import_react14.useMemo)(() => ({ value: l9, mode: p12 ? 1 : 0, get activeOptionIndex() {
    if (R5.current && M7 === null && b9.length > 0) {
      let m12 = b9.findIndex((T7) => !T7.dataRef.current.disabled);
      if (m12 !== -1)
        return m12;
    }
    return M7;
  } }), [l9, M7, b9]), g6 = f11.activeOptionIndex;
  t(() => {
    c8.current.onChange = (m12) => u2(f11.mode, { [0]() {
      return t10(m12);
    }, [1]() {
      let T7 = f11.value.slice(), h6 = T7.indexOf(m12);
      return h6 === -1 ? T7.push(m12) : T7.splice(h6, 1), t10(T7);
    } });
  }, [f11, t10, c8, f11]), t(() => d7({ type: 2, disabled: i9 }), [i9]), w([_8, y4, F10], () => {
    s9 === 0 && d7({ type: 1 });
  });
  let H5 = g6 === null ? null : b9[g6].dataRef.current.value, ie4 = (0, import_react14.useMemo)(() => ({ open: s9 === 0, disabled: i9, activeIndex: g6, activeOption: H5 }), [s9, i9, b9, g6]), w6 = (0, import_react14.useCallback)(() => {
    var T7;
    if (!y4.current)
      return;
    ...
    if (!T7)
      return;
    let { dataRef: h6 } = T7;
    c8.current.onChange(h6.current.value), w6();
  }, [b9, c8, y4]), te3 = (0, import_react14.useCallback)(() => {
    if (g6 !== null) {
      let { dataRef: m12, id: T7 } = b9[g6];
      c8.current.onChange(m12.current.value), w6(), d7({ type: 3, focus: a2.Specific, id: T7 });
    }
  }, [g6, b9, c8, y4]), ae4 = (0, import_react14.useMemo)(() => ({ selectOption: oe5, selectActiveOption: te3, openCombobox() {
    d7({ type: 0 }), R5.current = true;
  }, closeCombobox() {
    d7({ type: 1 }), R5.current = false;
  }, goToOption(m12, T7, h6) {
    return R5.current = false, m12 === a2.Specific ? d7({ type: 3, focus: a2.Specific, id: T7, trigger: h6 }) : d7({ type: 3, focus: m12, trigger: h6 });
  ...
  return import_react14.default.createElement(Z.Provider, { value: ae4 }, import_react14.default.createElement(ee.Provider, { value: f11 }, import_react14.default.createElement(Y.Provider, { value: S2 }, import_react14.default.createElement(C2, { value: u2(s9, { [0]: p4.Open, [1]: p4.Closed }) }, e4 != null && l9 != null && e2({ [e4]: l9 }).map(([m12, T7]) => import_react14.default.createElement(h3, { ...y({ key: m12, as: "input", type: "hidden", hidden: true, readOnly: true, name: m12, value: T7 }) })), A({ ourProps: le6, theirProps: x7, slot: ie4, defaultTag: De, name: "Combobox" })))));
});
var he = "input";
var Le = H(function(a3, n2) {
  var y4, _8;
  let { value: e4, onChange: l9, displayValue: t10, ...i9 } = a3, [r8] = U("Combobox.Input"), u7 = G(), p12 = W(), x7 = T(r8.inputRef, n2), R5 = r8.inputPropsRef, c8 = `headlessui-combobox-input-${I()}`, O10 = p(), v7 = s2(l9);
  t(() => {
  ...
  }, [r8.labelRef.current]), M7 = (0, import_react14.useMemo)(() => ({ open: r8.comboboxState === 0, disabled: r8.disabled }), [r8]), F10 = { ref: x7, id: c8, role: "combobox", type: "text", "aria-controls": (y4 = r8.optionsRef.current) == null ? void 0 : y4.id, "aria-expanded": r8.disabled ? void 0 : r8.comboboxState === 0, "aria-activedescendant": u7.activeOptionIndex === null || (_8 = r8.options[u7.activeOptionIndex]) == null ? void 0 : _8.id, "aria-multiselectable": u7.mode === 1 ? true : void 0, "aria-labelledby": b9, disabled: r8.disabled, onKeyDown: S2, onChange: s9 };
  return A({ ourProps: F10, theirProps: i9, slot: M7, defaultTag: he, name: "Combobox.Input" });
});
var Fe = "button";
...
var Be = H(function(a3, n2) {
  var S2;
  let { hold: e4 = false, ...l9 } = a3, [t10] = U("Combobox.Options"), i9 = G(), { optionsPropsRef: r8 } = t10, u7 = T(t10.optionsRef, n2), p12 = `headlessui-combobox-options-${I()}`, x7 = s5(), R5 = (() => x7 !== null ? x7 === p4.Open : t10.comboboxState === 0)();
  t(() => {
    var s9;
  ...
  let c8 = i(() => {
    var s9, b9, M7;
    return (M7 = (s9 = t10.labelRef.current) == null ? void 0 : s9.id) != null ? M7 : (b9 = t10.buttonRef.current) == null ? void 0 : b9.id;
...
var je = H(function(a3, n2) {
  ...
  t(() => {
    ...
    return f11.requestAnimationFrame(() => {
      var g6, H5;
      (H5 = (g6 = c8.current) == null ? void 0 : g6.scrollIntoView) == null || H5.call(g6, { block: "nearest" });
    }), f11.dispose;
  ...
  }, [u7, i9.inputRef, e4, S2]), M7 = (0, import_react14.useCallback)(() => {
    if (e4)
      return u7.goToOption(a2.Nothing);
    u7.goToOption(a2.Specific, p12);
  }, [e4, p12, u7]), F10 = (0, import_react14.useCallback)(() => {
  ...
  }, [e4, x7, u7, i9.comboboxState, i9.comboboxPropsRef]), _8 = (0, import_react14.useMemo)(() => ({ active: x7, selected: R5, disabled: e4 }), [x7, R5, e4]);
  return A({ ourProps: { id: p12, ref: v7, role: "option", tabIndex: e4 === true ? void 0 : -1, "aria-disabled": e4 === true ? true : void 0, "aria-selected": R5 === true ? true : void 0, disabled: void 0, onClick: b9, onFocus: M7, onPointerMove: F10, onMouseMove: F10, onPointerLeave: y4, onMouseLeave: y4 }, theirProps: t10, slot: _8, defaultTag: Ne, name: "Combobox.Option" });
});
...
function B2(u7, f11 = 30, { initialFocus: t10, containers: s9 } = {}) {
  let m12 = (0, import_react18.useRef)(null), c8 = (0, import_react18.useRef)(null), r8 = f7(), M7 = Boolean(f11 & 16), a3 = Boolean(f11 & 2), e4 = n(u7);
  return (0, import_react18.useEffect)(() => {
    !M7 || m12.current || (m12.current = e4 == null ? void 0 : e4.activeElement);
  }, [M7, e4]), (0, import_react18.useEffect)(() => {
    if (!!M7)
      return () => {
        S(m12.current), m12.current = null;
      };
  }, [M7]), (0, import_react18.useEffect)(() => {
    if (!a3)
      return;
    let l9 = u7.current;
    if (!l9)
...
var _ = H(function(n2, l9) {
  let { target: e4, ...r8 } = n2, o9 = { ref: T(l9) };
...
var O3 = H(function(t10, c8) {
  ...
  let o9 = t10, n2 = { ref: s9, ...e4.props, id: i9 };
...
var Ee2 = { [0](a3, e4) {
  return a3.titleId === e4.id ? a3 : { ...a3, titleId: e4.id };
} };
...
var Se2 = H(function(e4, t10) {
  let { open: o9, onClose: l9, initialFocus: p12, __demoMode: f11 = false, ...g6 } = e4, [m12, D6] = (0, import_react23.useState)(0), O10 = s5();
  ...
  let i9 = o9 ? 0 : 1, [y4, B7] = (0, import_react23.useReducer)(be, { titleId: null, descriptionId: null, panelRef: (0, import_react23.createRef)() }), R5 = (0, import_react23.useCallback)(() => l9(false), [l9]), H5 = (0, import_react23.useCallback)((r8) => B7({ type: 0, id: r8 }), [B7]), W6 = a() ? f11 ? false : i9 === 0 : false, S2 = m12 > 1, U7 = (0, import_react23.useContext)(_2) !== null, J3 = B2(d7, W6 ? u2(S2 ? "parent" : "leaf", { parent: j.RestoreFocus, leaf: j.All & ~j.FocusLock }) : j.None, { initialFocus: p12, containers: u7 });
  M2(d7, S2 ? W6 : false), w(() => {
    var n2, s9;
    return [...Array.from((n2 = P3 == null ? void 0 : P3.querySelectorAll("body > *")) != null ? n2 : []).filter((c8) => !(!(c8 instanceof HTMLElement) || c8.contains(J3.current) || y4.panelRef.current && c8.contains(y4.panelRef.current))), (s9 = y4.panelRef.current) != null ? s9 : d7.current];
  }, () => {
    i9 === 0 && (S2 || R5());
    ...
    if (!r8)
      return;
    let n2 = r8.documentElement, s9 = (Y4 = r8.defaultView) != null ? Y4 : window, c8 = n2.style.overflow, oe5 = n2.style.paddingRight, re4 = s9.innerWidth - n2.clientWidth;
  ...
  let [Q8, X6] = M3(), Z5 = `headlessui-dialog-${I()}`, ee4 = (0, import_react23.useMemo)(() => [{ dialogState: i9, close: R5, setTitleId: H5 }, y4], [i9, y4, R5, H5]), $4 = (0, import_react23.useMemo)(() => ({ open: i9 === 0 }), [i9]), te3 = { ref: z4, id: Z5, role: "dialog", "aria-modal": i9 === 0 ? true : void 0, "aria-labelledby": y4.titleId, "aria-describedby": Q8, onClick(r8) {
    r8.stopPropagation();
  } };
  ...
  }, []) }, import_react23.default.createElement(P, { force: true }, import_react23.default.createElement(K2, null, import_react23.default.createElement(_2.Provider, { value: ee4 }, import_react23.default.createElement(K2.Group, { target: d7 }, import_react23.default.createElement(P, { force: false }, import_react23.default.createElement(X6, { slot: $4, name: "Dialog.Description" }, A({ ourProps: te3, theirProps: g6, slot: $4, defaultTag: Ce, features: Oe, visible: i9 === 0, name: "Dialog" }))))))));
});
var we2 = "div";
...
var X = { [0]: (e4) => ({ ...e4, disclosureState: u2(e4.disclosureState, { [0]: 1, [1]: 0 }) }), [1]: (e4) => e4.disclosureState === 1 ? e4 : { ...e4, disclosureState: 1 }, [4](e4) {
  return e4.linkedPanel === true ? e4 : { ...e4, linkedPanel: true };
}, [5](e4) {
  return e4.linkedPanel === false ? e4 : { ...e4, linkedPanel: false };
}, [2](e4, t10) {
  return e4.buttonId === t10.buttonId ? e4 : { ...e4, buttonId: t10.buttonId };
}, [3](e4, t10) {
  return e4.panelId === t10.panelId ? e4 : { ...e4, panelId: t10.panelId };
} };
...
var te = H(function(t10, o9) {
  let { defaultOpen: n2 = false, ...r8 } = t10, u7 = `headlessui-disclosure-button-${I()}`, l9 = `headlessui-disclosure-panel-${I()}`, a3 = (0, import_react24.useRef)(null), D6 = T(o9, p2((f11) => {
    a3.current = f11;
  ...
  let T7 = (0, import_react24.useCallback)((f11) => {
    ...
    if (!A4)
      return;
    let I4 = (() => f11 ? f11 instanceof HTMLElement ? f11 : f11.current instanceof HTMLElement ? f11.current : A4.getElementById(u7) : A4.getElementById(u7))();
    I4 == null || I4.focus();
...
var O5 = H(function(t10, o9) {
  let e4 = (0, import_react25.useRef)(null), l9 = T(e4, o9), { initialFocus: s9, ...u7 } = t10, a3 = a();
...
var fe = { [1](t10) {
  return t10.disabled || t10.listboxState === 1 ? t10 : { ...t10, activeOptionIndex: null, listboxState: 1 };
}, [0](t10) {
  ...
  return o9 !== -1 && (i9 = o9), { ...t10, listboxState: 0, activeOptionIndex: i9 };
}, [2](t10, i9) {
  return t10.disabled === i9.disabled ? t10 : { ...t10, disabled: i9.disabled };
}, [3](t10, i9) {
  return t10.orientation === i9.orientation ? t10 : { ...t10, orientation: i9.orientation };
}, [4](t10, i9) {
  var o9;
  ...
  return { ...t10, ...n2, searchQuery: "", activeOptionIndex: e4, activationTrigger: (o9 = i9.trigger) != null ? o9 : 1 };
}, [5]: (t10, i9) => {
  if (t10.disabled || t10.listboxState === 1)
    return t10;
  ...
  return s9 === -1 || s9 === t10.activeOptionIndex ? { ...t10, searchQuery: o9 } : { ...t10, searchQuery: o9, activeOptionIndex: s9, activationTrigger: 1 };
}, [6](t10) {
  return t10.disabled || t10.listboxState === 1 || t10.searchQuery === "" ? t10 : { ...t10, searchQuery: "" };
}, [7]: (t10, i9) => {
  ...
  return { ...t10, ...n2, activationTrigger: 1 };
} };
...
var xe2 = H(function(i9, n2) {
  let { value: e4, name: o9, onChange: p12, disabled: r8 = false, horizontal: s9 = false, multiple: u7 = false, ...a3 } = i9;
  ...
  return import_react26.default.createElement(V2.Provider, { value: v7 }, import_react26.default.createElement(C2, { value: u2(f11, { [0]: p4.Open, [1]: p4.Closed }) }, o9 != null && e4 != null && e2({ [o9]: e4 }).map(([L8, T7]) => import_react26.default.createElement(h3, { ...y({ key: L8, as: "input", type: "hidden", hidden: true, readOnly: true, name: L8, value: T7 }) })), A({ ourProps: P3, theirProps: a3, slot: c8, defaultTag: Te, name: "Listbox" })));
});
var ye2 = "button";
...
var ue2 = { [1](t10) {
  ...
  return { ...t10, ...a3, searchQuery: "", activeItemIndex: e4, activationTrigger: (r8 = i9.trigger) != null ? r8 : 1 };
}, [3]: (t10, i9) => {
  ...
  return o9 === -1 || o9 === t10.activeItemIndex ? { ...t10, searchQuery: r8 } : { ...t10, searchQuery: r8, activeItemIndex: o9, activationTrigger: 1 };
}, [4](t10) {
  ...
  return { ...t10, ...a3, activationTrigger: 1 };
} };
...
var ce2 = H(function(i9, a3) {
  ...
  w([s9, u7], (M7, R5) => {
    var T7;
    r8 === 0 && (o9({ type: 1 }), O(R5, T3.Loose) || (M7.preventDefault(), (T7 = s9.current) == null || T7.focus()));
  });
...
var de2 = H(function(i9, a3) {
  ...
  }, [r8, o9, e4, i9.disabled]), f11 = (0, import_react27.useMemo)(() => ({ open: e4.menuState === 0 }), [e4]), M7 = i9, R5 = { ref: u7, id: s9, type: s6(i9, e4.buttonRef), "aria-haspopup": true, "aria-controls": (T7 = e4.itemsRef.current) == null ? void 0 : T7.id, "aria-expanded": i9.disabled ? void 0 : e4.menuState === 0, onKeyDown: l9, onKeyUp: p12, onClick: g6 };
  return A({ ourProps: R5, theirProps: M7, slot: f11, defaultTag: pe3, name: "Menu.Button" });
});
var me2 = "div";
...
var Te2 = H(function(i9, a3) {
  ...
  }, [r8, l9, e4, s9]), M7 = (0, import_react27.useCallback)((n2) => {
    switch (n2.key) {
      case o5.Space:
        n2.preventDefault();
        break;
    }
  }, []), R5 = (0, import_react27.useMemo)(() => ({ open: e4.menuState === 0 }), [e4]), T7 = i9, c8 = { "aria-activedescendant": e4.activeItemIndex === null || (b9 = e4.items[e4.activeItemIndex]) == null ? void 0 : b9.id, "aria-labelledby": (O10 = e4.buttonRef.current) == null ? void 0 : O10.id, id: o9, onKeyDown: f11, onKeyUp: M7, role: "menu", tabIndex: 0, ref: u7 };
...
var ye3 = H(function(i9, a3) {
  let { disabled: e4 = false, ...r8 } = i9, [u7, s9] = C5("Menu.Item"), o9 = `headlessui-menu-item-${I()}`, l9 = u7.activeItemIndex !== null ? u7.items[u7.activeItemIndex].id === o9 : false, p12 = (0, import_react27.useRef)(null), g6 = T(a3, p12);
  t(() => {
  ...
  let M7 = (0, import_react27.useCallback)((n2) => {
    if (e4)
  ...
  return A({ ourProps: { id: o9, ref: g6, role: "menuitem", tabIndex: e4 === true ? void 0 : -1, "aria-disabled": e4 === true ? true : void 0, disabled: void 0, onClick: M7, onFocus: R5, onPointerMove: T7, onMouseMove: T7, onPointerLeave: c8, onMouseLeave: c8 }, theirProps: r8, slot: b9, defaultTag: Ie3, name: "Menu.Item" });
});
...
var de3 = { [0]: (a3) => ({ ...a3, popoverState: u2(a3.popoverState, { [0]: 1, [1]: 0 }) }), [1](a3) {
  return a3.popoverState === 1 ? a3 : { ...a3, popoverState: 1 };
}, [2](a3, o9) {
  return a3.button === o9.button ? a3 : { ...a3, button: o9.button };
}, [3](a3, o9) {
  return a3.buttonId === o9.buttonId ? a3 : { ...a3, buttonId: o9.buttonId };
}, [4](a3, o9) {
  return a3.panel === o9.panel ? a3 : { ...a3, panel: o9.panel };
}, [5](a3, o9) {
  return a3.panelId === o9.panelId ? a3 : { ...a3, panelId: o9.panelId };
} };
...
var Se4 = H(function(o9, f11) {
  ...
  let y4 = (0, import_react28.useCallback)((r8) => {
    ...
    T7 == null || T7.focus();
  }, [u7, t10]), b9 = (0, import_react28.useMemo)(() => ({ close: y4 }), [y4]), g6 = (0, import_react28.useMemo)(() => ({ open: v7 === 0, close: y4 }), [v7, y4]), C9 = o9, h6 = { ref: l9 };
  return import_react28.default.createElement(z2.Provider, { value: s9 }, import_react28.default.createElement(J.Provider, { value: b9 }, import_react28.default.createElement(C2, { value: u2(v7, { [0]: p4.Open, [1]: p4.Closed }) }, A({ ourProps: h6, theirProps: C9, slot: g6, defaultTag: Ee3, name: "Popover" }))));
});
var be3 = "button";
var me3 = H(function(o9, f11) {
  ...
  }, [P3, e4.button, e4.popoverState, e4.buttonId, o9.disabled, i9, v7]), b9 = (0, import_react28.useMemo)(() => ({ open: e4.popoverState === 0 }), [e4]), g6 = s6(o9, n2), C9 = o9, h6 = v7 ? { ref: E5, type: g6, onKeyDown: d7, onClick: y4 } : { ref: t10, id: e4.buttonId, type: g6, "aria-expanded": o9.disabled ? void 0 : e4.popoverState === 0, "aria-controls": e4.panel ? e4.panelId : void 0, onKeyDown: d7, onKeyUp: p12, onClick: y4 };
  return A({ ourProps: h6, theirProps: C9, slot: b9, defaultTag: be3, name: "Popover.Button" });
});
var ge2 = "div";
...
var Ie4 = H(function(o9, f11) {
  let { focus: e4 = false, ...P3 } = o9, [n2, l9] = N4("Popover.Panel"), { close: i9 } = oe3("Popover.Panel"), s9 = (0, import_react28.useRef)(null), v7 = T(s9, f11, (p12) => {
    l9({ type: 4, panel: p12 });
  ...
  (0, import_react28.useEffect)(() => () => l9({ type: 4, panel: null }), [l9]), (0, import_react28.useEffect)(() => {
    ...
    if (y4 === p5.Overflow) {
      if (!n2.button)
        return;
      let g6 = N(t10.body), C9 = g6.indexOf(n2.button), h6 = g6.splice(C9 + 1).filter((r8) => {
        var T7;
        return !((T7 = s9.current) != null && T7.contains(r8));
      });
      F3(h6, E2.First) === p5.Error && F3(t10.body, E2.First);
    }
...
var M5 = H(function(t10, s9) {
  let { passive: e4 = false, ...o9 } = t10, r8 = f10(), a3 = `headlessui-label-${I()}`, i9 = T(s9);
  t(() => r8.register(a3), [a3, r8.register]);
  let n2 = { ref: i9, ...r8.props, id: a3 };
...
var se4 = { [0](n2, o9) {
  ...
  return { ...n2, options: h2(t10, (r8) => r8.element.current) };
}, [1](n2, o9) {
  let t10 = n2.options.slice(), r8 = n2.options.findIndex((m12) => m12.id === o9.id);
  return r8 === -1 ? n2 : (t10.splice(r8, 1), { ...n2, options: t10 });
} };
...
var fe3 = H(function(o9, t10) {
  let { value: r8, name: m12, onChange: f11, disabled: R5 = false, ...I4 } = o9, [{ options: a3 }, A4] = (0, import_react31.useReducer)(ue3, { options: [] }), [T7, C9] = B4(), [k6, c8] = M3(), y4 = `headlessui-radiogroup-${I()}`, g6 = (0, import_react31.useRef)(null), b9 = T(g6, t10), E5 = (0, import_react31.useMemo)(() => a3.find((e4) => !e4.propsRef.current.disabled), [a3]), D6 = (0, import_react31.useMemo)(() => a3.some((e4) => e4.propsRef.current.value === r8), [a3, r8]), s9 = (0, import_react31.useCallback)((e4) => {
    var i9;
    if (R5 || e4 === r8)
      return false;
  ...
  let h6 = (0, import_react31.useCallback)((e4) => {
    let d7 = g6.current;
    if (!d7)
      return;
  ...
  }, [g6, a3, s9]), L8 = (0, import_react31.useCallback)((e4) => (A4({ type: 0, ...e4 }), () => A4({ type: 1, id: e4.id })), [A4]), S2 = (0, import_react31.useMemo)(() => ({ registerOption: L8, firstOption: E5, containsCheckedOption: D6, change: s9, disabled: R5, value: r8 }), [L8, E5, D6, s9, R5, r8]), _8 = { ref: b9, id: y4, role: "radiogroup", "aria-labelledby": T7, "aria-describedby": k6, onKeyDown: h6 };
  return import_react31.default.createElement(c8, { name: "RadioGroup.Description" }, import_react31.default.createElement(C9, { name: "RadioGroup.Label" }, import_react31.default.createElement(U4.Provider, { value: S2 }, m12 != null && r8 != null && e2({ [m12]: r8 }).map(([e4, d7]) => import_react31.default.createElement(h3, { ...y({ key: e4, as: "input", type: "radio", checked: d7 != null, hidden: true, readOnly: true, name: e4, value: d7 }) })), A({ ourProps: _8, theirProps: I4, defaultTag: ce4, name: "RadioGroup" }))));
});
var be4 = ((t10) => (t10[t10.Empty = 1] = "Empty", t10[t10.Active = 2] = "Active", t10))(be4 || {});
var me4 = "div";
var Re3 = H(function(o9, t10) {
  let r8 = (0, import_react31.useRef)(null), m12 = T(r8, t10), f11 = `headlessui-radiogroup-option-${I()}`, [R5, I4] = B4(), [a3, A4] = M3(), { addFlag: T7, removeFlag: C9, hasFlag: k6 } = b6(1), { value: c8, disabled: y4 = false, ...g6 } = o9, b9 = (0, import_react31.useRef)({ value: c8, disabled: y4 });
  t(() => {
    b9.current.value = c8;
  }, [c8, b9]), t(() => {
    b9.current.disabled = y4;
  }, [y4, b9]);
  let { registerOption: E5, disabled: D6, change: s9, firstOption: h6, containsCheckedOption: L8, value: S2 } = z3("RadioGroup.Option");
  t(() => E5({ id: f11, element: r8, propsRef: b9 }), [f11, E5, r8, o9]);
  let _8 = (0, import_react31.useCallback)(() => {
    var H5;
    !s9(c8) || (T7(2), (H5 = r8.current) == null || H5.focus());
  }, [T7, s9, c8]), e4 = (0, import_react31.useCallback)(() => T7(2), [T7]), d7 = (0, import_react31.useCallback)(() => C9(2), [C9]), i9 = (h6 == null ? void 0 : h6.id) === f11, p12 = D6 || y4, l9 = S2 === c8, u7 = { ref: m12, id: f11, role: "radio", "aria-checked": l9 ? "true" : "false", "aria-labelledby": R5, "aria-describedby": a3, "aria-disabled": p12 ? true : void 0, tabIndex: (() => p12 ? -1 : l9 || !L8 && i9 ? 0 : -1)(), onClick: p12 ? void 0 : _8, onFocus: p12 ? void 0 : e4, onBlur: p12 ? void 0 : d7 }, G5 = (0, import_react31.useMemo)(() => ({ checked: l9, disabled: p12, active: k6(2) }), [l9, p12, k6]);
  return import_react31.default.createElement(A4, { name: "RadioGroup.Description" }, import_react31.default.createElement(I4, { name: "RadioGroup.Label" }, A({ ourProps: u7, theirProps: g6, slot: G5, defaultTag: me4, name: "RadioGroup.Option" })));
});
...
var V5 = H(function(n2, i9) {
  let { checked: e4, onChange: a3, name: o9, value: d7, ...u7 } = n2, p12 = `headlessui-switch-${I()}`, t10 = (0, import_react32.useContext)(m11), h6 = (0, import_react32.useRef)(null), S2 = T(h6, i9, t10 === null ? null : t10.setSwitch), s9 = (0, import_react32.useCallback)(() => a3(!e4), [a3, e4]), w6 = (0, import_react32.useCallback)((r8) => {
  ...
  }, [s9]), P3 = (0, import_react32.useCallback)((r8) => r8.preventDefault(), []), v7 = (0, import_react32.useMemo)(() => ({ checked: e4 }), [e4]), g6 = { id: p12, ref: S2, role: "switch", type: s6(n2, h6), tabIndex: 0, "aria-checked": e4, "aria-labelledby": t10 == null ? void 0 : t10.labelledby, "aria-describedby": t10 == null ? void 0 : t10.describedby, onClick: w6, onKeyUp: E5, onKeyPress: P3 };
  return import_react32.default.createElement(import_react32.default.Fragment, null, o9 != null && e4 && import_react32.default.createElement(h3, { ...y({ as: "input", type: "checkbox", hidden: true, readOnly: true, checked: e4, name: o9, value: d7 }) }), A({ ourProps: g6, theirProps: u7, slot: v7, defaultTag: N5, name: "Switch" }));
});
...
// node_modules/@headlessui/react/dist/components/tabs/tabs.js
var Z3 = ((r8) => (r8[r8.SetSelectedIndex = 0] = "SetSelectedIndex", r8[r8.SetOrientation = 1] = "SetOrientation", r8[r8.SetActivation = 2] = "SetActivation", r8[r8.RegisterTab = 3] = "RegisterTab", r8[r8.UnregisterTab = 4] = "UnregisterTab", r8[r8.RegisterPanel = 5] = "RegisterPanel", r8[r8.UnregisterPanel = 6] = "UnregisterPanel", r8[r8.ForceRerender = 7] = "ForceRerender", r8))(Z3 || {});
var ee3 = { [0](e4, t10) {
  return e4.selectedIndex === t10.index ? e4 : { ...e4, selectedIndex: t10.index };
}, [1](e4, t10) {
  return e4.orientation === t10.orientation ? e4 : { ...e4, orientation: t10.orientation };
}, [2](e4, t10) {
  return e4.activation === t10.activation ? e4 : { ...e4, activation: t10.activation };
}, [3](e4, t10) {
  return e4.tabs.includes(t10.tab) ? e4 : { ...e4, tabs: [...e4.tabs, t10.tab] };
}, [4](e4, t10) {
  return { ...e4, tabs: e4.tabs.filter((i9) => i9 !== t10.tab) };
}, [5](e4, t10) {
  return e4.panels.includes(t10.panel) ? e4 : { ...e4, panels: [...e4.panels, t10.panel] };
}, [6](e4, t10) {
  return { ...e4, panels: e4.panels.filter((i9) => i9 !== t10.panel) };
}, [7](e4) {
  return { ...e4 };
} };
var W4 = (0, import_react34.createContext)(null);
W4.displayName = "TabsContext";
var j6 = (0, import_react34.createContext)(null);
j6.displayName = "TabsSSRContext";
function F8(e4) {
  let t10 = (0, import_react34.useContext)(W4);
  if (t10 === null) {
    let i9 = new Error(`<${e4} /> is missing a parent <Tab.Group /> component.`);
    throw Error.captureStackTrace && Error.captureStackTrace(i9, F8), i9;
  }
  return t10;
}
function te2(e4, t10) {
  return u2(t10.type, ee3, e4, t10);
}
var ne3 = import_react34.Fragment;
var re3 = H(function(t10, i9) {
  let { defaultIndex: u7 = 0, vertical: x7 = false, manual: d7 = false, onChange: f11, selectedIndex: l9 = null, ...r8 } = t10;
  const p12 = x7 ? "vertical" : "horizontal", T7 = d7 ? "manual" : "auto";
  let c8 = T(i9), [a3, o9] = (0, import_react34.useReducer)(te2, { selectedIndex: typeof window == "undefined" ? l9 != null ? l9 : u7 : null, tabs: [], panels: [], orientation: p12, activation: T7 }), R5 = (0, import_react34.useMemo)(() => ({ selectedIndex: a3.selectedIndex }), [a3.selectedIndex]), L8 = s2(f11 || (() => {
  })), S2 = s2(a3.tabs);
  (0, import_react34.useEffect)(() => {
    o9({ type: 1, orientation: p12 });
  }, [p12]), (0, import_react34.useEffect)(() => {
    o9({ type: 2, activation: T7 });
  }, [T7]), t(() => {
    if (a3.tabs.length <= 0 || l9 === null && a3.selectedIndex !== null)
      return;
    let s9 = a3.tabs.map((n2) => n2.current).filter(Boolean), b9 = s9.filter((n2) => !n2.hasAttribute("disabled")), m12 = l9 != null ? l9 : u7;
    if (m12 < 0)
      o9({ type: 0, index: s9.indexOf(b9[0]) });
    else if (m12 > a3.tabs.length)
      o9({ type: 0, index: s9.indexOf(b9[b9.length - 1]) });
    else {
      let n2 = s9.slice(0, m12), C9 = [...s9.slice(m12), ...n2].find((q2) => b9.includes(q2));
      if (!C9)
        return;
      o9({ type: 0, index: s9.indexOf(C9) });
    }
  }, [u7, l9, a3.tabs, a3.selectedIndex]);
  let A4 = (0, import_react34.useRef)(a3.selectedIndex);
  (0, import_react34.useEffect)(() => {
    A4.current = a3.selectedIndex;
  }, [a3.selectedIndex]);
  let h6 = (0, import_react34.useMemo)(() => [a3, { dispatch: o9, change(s9) {
    A4.current !== s9 && L8.current(s9), A4.current = s9, o9({ type: 0, index: s9 });
  } }], [a3, o9]), w6 = (0, import_react34.useRef)(0), H5 = { ref: c8 };
  return import_react34.default.createElement(j6.Provider, { value: typeof window == "undefined" ? w6 : null }, import_react34.default.createElement(W4.Provider, { value: h6 }, import_react34.default.createElement(F7, { onFocus: () => {
    var s9, b9;
    for (let m12 of S2.current)
      if (((s9 = m12.current) == null ? void 0 : s9.tabIndex) === 0)
        return (b9 = m12.current) == null || b9.focus(), true;
    return false;
  } }), A({ ourProps: H5, theirProps: r8, slot: R5, defaultTag: ne3, name: "Tabs" })));
});
var ae3 = "div";
var le5 = H(function(t10, i9) {
  let [{ selectedIndex: u7, orientation: x7 }] = F8("Tab.List"), d7 = T(i9);
  return A({ ourProps: { ref: d7, role: "tablist", "aria-orientation": x7 }, theirProps: t10, slot: { selectedIndex: u7 }, defaultTag: ae3, name: "Tabs.List" });
});
var oe4 = "button";
var ie3 = H(function(t10, i9) {
  var b9, m12;
  let u7 = `headlessui-tabs-tab-${I()}`, [{ selectedIndex: x7, tabs: d7, panels: f11, orientation: l9, activation: r8 }, { dispatch: p12, change: T7 }] = F8("Tab"), c8 = (0, import_react34.useRef)(null), a3 = T(c8, i9, (n2) => {
    !n2 || p12({ type: 7 });
  });
  t(() => (p12({ type: 3, tab: c8 }), () => p12({ type: 4, tab: c8 })), [p12, c8]);
  let o9 = d7.indexOf(c8), R5 = o9 === x7, L8 = (0, import_react34.useCallback)((n2) => {
    let g6 = d7.map((C9) => C9.current).filter(Boolean);
    if (n2.key === o5.Space || n2.key === o5.Enter) {
      n2.preventDefault(), n2.stopPropagation(), T7(o9);
      return;
    }
    switch (n2.key) {
      case o5.Home:
      case o5.PageUp:
        return n2.preventDefault(), n2.stopPropagation(), F3(g6, E2.First);
      case o5.End:
      case o5.PageDown:
        return n2.preventDefault(), n2.stopPropagation(), F3(g6, E2.Last);
    }
    return u2(l9, { vertical() {
      if (n2.key === o5.ArrowUp)
        return F3(g6, E2.Previous | E2.WrapAround);
      if (n2.key === o5.ArrowDown)
        return F3(g6, E2.Next | E2.WrapAround);
    }, horizontal() {
      if (n2.key === o5.ArrowLeft)
        return F3(g6, E2.Previous | E2.WrapAround);
      if (n2.key === o5.ArrowRight)
        return F3(g6, E2.Next | E2.WrapAround);
    } });
  }, [d7, l9, o9, T7]), S2 = (0, import_react34.useCallback)(() => {
    var n2;
    (n2 = c8.current) == null || n2.focus();
  }, [c8]), A4 = (0, import_react34.useCallback)(() => {
    var n2;
    (n2 = c8.current) == null || n2.focus(), T7(o9);
  }, [T7, o9, c8]), h6 = (0, import_react34.useCallback)((n2) => {
    n2.preventDefault();
  }, []), w6 = (0, import_react34.useMemo)(() => ({ selected: R5 }), [R5]), H5 = t10, s9 = { ref: a3, onKeyDown: L8, onFocus: r8 === "manual" ? S2 : A4, onMouseDown: h6, onClick: A4, id: u7, role: "tab", type: s6(t10, c8), "aria-controls": (m12 = (b9 = f11[o9]) == null ? void 0 : b9.current) == null ? void 0 : m12.id, "aria-selected": R5, tabIndex: R5 ? 0 : -1 };
  return A({ ourProps: s9, theirProps: H5, slot: w6, defaultTag: oe4, name: "Tabs.Tab" });
});
var se5 = "div";
var ue4 = H(function(t10, i9) {
  let [{ selectedIndex: u7 }] = F8("Tab.Panels"), x7 = T(i9), d7 = (0, import_react34.useMemo)(() => ({ selectedIndex: u7 }), [u7]);
  return A({ ourProps: { ref: x7 }, theirProps: t10, slot: d7, defaultTag: se5, name: "Tabs.Panels" });
});
var ce6 = "div";
var pe5 = b.RenderStrategy | b.Static;
var de5 = H(function(t10, i9) {
  var S2, A4;
  let [{ selectedIndex: u7, tabs: x7, panels: d7 }, { dispatch: f11 }] = F8("Tab.Panel"), l9 = (0, import_react34.useContext)(j6);
  l9 !== null && u7 === null && (u7 = 0);
  let r8 = `headlessui-tabs-panel-${I()}`, p12 = (0, import_react34.useRef)(null), T7 = T(p12, i9, (h6) => {
    !h6 || f11({ type: 7 });
  });
  t(() => (f11({ type: 5, panel: p12 }), () => f11({ type: 6, panel: p12 })), [f11, p12]);
  let c8 = d7.indexOf(p12), a3 = l9 === null ? c8 === u7 : l9.current++ === u7, o9 = (0, import_react34.useMemo)(() => ({ selected: a3 }), [a3]), R5 = t10, L8 = { ref: T7, id: r8, role: "tabpanel", "aria-labelledby": (A4 = (S2 = x7[c8]) == null ? void 0 : S2.current) == null ? void 0 : A4.id, tabIndex: a3 ? 0 : -1 };
  return A({ ourProps: L8, theirProps: R5, slot: o9, defaultTag: ce6, features: pe5, visible: a3, name: "Tabs.Panel" });
});
var _e3 = Object.assign(ie3, { Group: re3, List: le5, Panels: ue4, Panel: de5 });
...
var N7 = (0, import_react35.createContext)(null);
N7.displayName = "TransitionContext";
var he2 = ((t10) => (t10.Visible = "visible", t10.Hidden = "hidden", t10))(he2 || {});
function ge3() {
  let e4 = (0, import_react35.useContext)(N7);
  if (e4 === null)
...
function F9(e4) {
  return "children" in e4 ? F9(e4.children) : e4.current.filter(({ state: r8 }) => r8 === "visible").length > 0;
}
function X5(e4) {
  let r8 = s2(e4), t10 = (0, import_react35.useRef)([]), n2 = f7(), u7 = s2((s9, o9 = x.Hidden) => {
    ...
    i9 !== -1 && (u2(o9, { [x.Unmount]() {
      ...
      var d7;
      !F9(t10) && n2.current && ((d7 = r8.current) == null || d7.call(r8));
    }));
  }), m12 = s2((s9) => {
...
var be5 = ["beforeEnter", "afterEnter", "beforeLeave", "afterLeave"];
function Y3(e4) {
  var t10;
  let r8 = {};
  for (let n2 of be5)
...
function Se5(e4) {
  let r8 = (0, import_react35.useRef)(Y3(e4));
...
var $3 = H(function(r8, t10) {
  let { beforeEnter: n2, afterEnter: u7, beforeLeave: m12, afterLeave: s9, enter: o9, enterFrom: i9, enterTo: d7, entered: S2, leave: x7, leaveFrom: E5, leaveTo: L8, ...p12 } = r8, h6 = (0, import_react35.useRef)(null), y4 = T(h6, t10), [f11, A4] = (0, import_react35.useState)("visible"), D6 = p12.unmount ? x.Unmount : x.Hidden, { show: g6, appear: ee4, initial: te3 } = ge3(), { register: P3, unregister: H5 } = ve4(), O10 = (0, import_react35.useRef)(null), a3 = I(), re4 = (0, import_react35.useRef)(false), k6 = X5(() => {
    re4.current || (A4("hidden"), H5.current(a3));
  });
  (0, import_react35.useEffect)(() => {
    ...
    if (D6 === x.Hidden && !!a3) {
      ...
      u2(f11, { ["hidden"]: () => H5.current(a3), ["visible"]: () => P3.current(a3) });
    }
  }, [f11, a3, P3, H5, g6, D6]);
  let ne4 = s2({ enter: c7(o9), enterFrom: c7(i9), enterTo: c7(d7), entered: c7(S2), leave: c7(x7), leaveFrom: c7(E5), leaveTo: c7(L8) }), ie4 = Se5({ beforeEnter: n2, afterEnter: u7, beforeLeave: m12, afterLeave: s9 }), w6 = a();
  (0, import_react35.useEffect)(() => {
    if (w6 && f11 === "visible" && h6.current === null)
      throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [h6, f11, w6]);
  let M7 = te3 && !ee4, se6 = (() => !w6 || M7 || O10.current === g6 ? "idle" : g6 ? "enter" : "leave")();
  x6({ container: h6, classes: ne4, events: ie4, direction: se6, onStart: s2(() => {
  }), onStop: s2((le6) => {
    le6 === "leave" && !F9(k6) && (A4("hidden"), H5.current(a3));
  }) }), (0, import_react35.useEffect)(() => {
    !M7 || (D6 === x.Hidden ? O10.current = null : O10.current = g6);
  }, [g6, M7, f11]);
...
var j7 = H(function(r8, t10) {
  let { show: n2, appear: u7 = false, unmount: m12, ...s9 } = r8, o9 = T(t10);
  a();
  let i9 = s5();
  ...
  let h6 = (0, import_react35.useMemo)(() => ({ show: n2, appear: u7, initial: E5 }), [n2, u7, E5]);
  (0, import_react35.useEffect)(() => {
    n2 ? S2("visible") : F9(x7) || S2("hidden");
  }, [n2, x7]);
  let y4 = { unmount: m12 };
  return import_react35.default.createElement(R4.Provider, { value: x7 }, import_react35.default.createElement(N7.Provider, { value: h6 }, A({ ourProps: { ...y4, as: import_react35.Fragment, children: import_react35.default.createElement($3, { ref: o9, ...y4, ...s9 }) }, theirProps: {}, defaultTag: import_react35.Fragment, features: Z4, visible: d7 === "visible", name: "Transition" })));
});
function Ee4(e4) {
  let r8 = (0, import_react35.useContext)(N7) !== null, t10 = s5() !== null;
  return import_react35.default.createElement(import_react35.default.Fragment, null, !r8 && t10 ? import_react35.default.createElement(j7, { ...e4 }) : import_react35.default.createElement($3, { ...e4 }));
}
